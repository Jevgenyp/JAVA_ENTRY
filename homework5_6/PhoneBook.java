...
public class PhoneBook {
    ...
    public static void main(String[] args) {
        ...
        phoneBook.addContact("Анна Мусина", new String[]{"23575779"});
        ...
        String[] ivanPhones = phoneBook.getPhones("Иван Иванов");
        System.out.println("Иван Иванов's phone numbers: " + Arrays.toString(ivanPhones));
        
        // Remove a contact
        phoneBook.removeContact("Павел Чернов");
        
        // Print all contacts again to confirm removal
        phoneBook.printAllContacts();
